  ...
  return (
    <aside className="space-y-6">
      <div className="p-6 rounded-xl border-2 border-muted space-y-6">
        ...
        <Button
          className="w-full min-h-14 bg-foreground text-background text-base xl:text-lg hover:opacity-90 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4"
          onClick={onClick}
          disabled={disabled}
        >
          Save
