            ...
            <div className="flex flex-col md:flex-row">
              <div className="flex-1 p-6 md:p-8">
                <div className="flex items-center gap-4 mb-4">
                  <Badge className="bg-accent/10 text-accent border-0 font-black">{resource.relevancePercentage}% Match</Badge>
                ...
                <Accordion
                  type="single"
                  collapsible
                  defaultValue={index === 0 ? 'sections' : undefined}
                  className="w-full border-t border-muted"
                >
                  <AccordionItem value="sections" className="border-none">
                    <AccordionTrigger className="text-accent font-bold hover:text-accent/80 hover:no-underline hover:bg-accent/5 focus-visible:bg-accent/10 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 py-4 px-3 -mx-3 rounded-lg min-h-[44px] transition-colors group">
