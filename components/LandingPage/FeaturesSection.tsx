...
const features = [
  {
    ...
    description: "Tell us your aspirations and our AI identifies the most impactful skills to develop based on your career stage and interests."
  },
  {
    id: 2,
    icon: Route,
    title: "Smart Learning Roadmaps",
    description: "AI generates personalized weekly schedules with curated resources, adapting the pace and content to match your learning style."
  },
  {
    id: 3,
    icon: Brain,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-foreground sm:text-5xl">
            AI that understands your learning journey
          </h2>
