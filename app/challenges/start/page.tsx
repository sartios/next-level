      ...
      <Card className="border-2">
        <CardContent className="p-6 space-y-6">
          ...
          <div className="flex justify-between pt-4 border-t">
            <Button variant="outline" asChild className="font-medium text-base xl:text-lg min-h-11">
              <Link href="/challenges">End Challenge</Link>
            </Button>

            {!showResult ? (
              <Button onClick={submitAnswer} disabled={!selectedAnswer} className="font-medium text-base xl:text-lg min-h-11">
                Submit Answer
              </Button>
            ) : isCorrect ? (
              <Button onClick={nextQuestion} className="font-medium text-base xl:text-lg min-h-11">
              ...
              <Button
                ...
                className="font-medium text-base xl:text-lg min-h-11"
              >
                <RotateCcw className="h-5 w-5 mr-2" />
                Try Again
              </Button>
